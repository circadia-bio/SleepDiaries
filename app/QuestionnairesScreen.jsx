...
const styles = StyleSheet.create({
  ...
  card:         { backgroundColor: '#fff', borderRadius: 16, borderWidth: 1.5, borderColor: '#B0CCEE', overflow: 'hidden' },
  ...
  qResultRow:   { gap: 4 },
  qBadge:       { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 5, borderWidth: 1.5, borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4, flexShrink: 1 },
