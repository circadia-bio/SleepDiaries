      ...
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <View style={[styles.inner, { paddingBottom: insets.bottom + 40 }]}>
          ...
          <View style={styles.inputWrapper}>
            <TextInput
              style={[styles.input, { fontFamily: FONTS.bodyMedium }]}
          ...
          <View style={styles.inputWrapper}>
            <TextInput
              style={[styles.input, styles.inputOptional, { fontFamily: FONTS.bodyMedium }]}
          ...
          >
            {loading
              ...
              : <Text style={[styles.loginBtnText, { fontFamily: FONTS.body }]}>{t('login.cta')}</Text>
            }
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  inner: {
    ...
    paddingHorizontal: 36, paddingTop: 24, gap: 14,
  },
  subtitle:     { fontSize: 17, color: '#4A6A8A', textAlign: 'center' },
  ...
  input: {
    ...
    paddingHorizontal: 20, paddingVertical: 16, fontSize: 17, color: '#1E3A5F',
  },
  loginBtn: {
    backgroundColor: '#5B9BC5', borderRadius: 30, paddingVertical: 17, alignItems: 'center',
    shadowColor: '#3A7AAA', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4,
  },
  loginBtnDisabled: { backgroundColor: '#A0BDD4', shadowOpacity: 0 },
  loginBtnText:     { color: '#fff', fontSize: 19, letterSpacing: 0.3 },
  inputOptional:    { borderStyle: 'dashed', borderColor: '#A0C8E8' },
  optionalLabel:    { fontSize: 14, color: '#94A3B8', paddingHorizontal: 4 },
});
